...
public class PR_GUI extends javax.swing.JFrame {
    ...
    private void executeActionTaken(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeActionTaken
        ...
        if (isTrained) {
            ...
            printAreaClassifier.setText("You need to train Classifier first!");
        }
    ...
    private void executeAdvancedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeAdvancedActionPerformed
        if (isTrained) {
            ...
            printAreaClassifierAdv.setText("You need to train Classifier first!");
        }
        ...
        if (isRead && isParsed) {
            if (bootStrapButton.isSelected()) {
                if (getKLoops() > 0 && getKLoops() < 10000) {
                    ...
                    printAreaClassifierAdv.setText("Insert proper number of loops");
                }

            } else if (crossValidationButton.isSelected()) {

                if (Integer.parseInt(kSections.getText()) > 1) {
                    ...
                    printAreaClassifierAdv.setText("Select number of Sections > 1");
                }

            } else {
                printAreaClassifierAdv.setText("Check the desired classification method bootstrap/crossvalidation");
            }
        } else if (!isRead) {
